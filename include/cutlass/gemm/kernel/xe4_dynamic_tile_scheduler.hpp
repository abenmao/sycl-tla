...
class DynamicPersistentTileSchedulerXe4 {
public:
  ...
  using Params = DynamicPersistentTileSchedulerXe4Params;
  ...
  CUTLASS_DEVICE
  explicit
  DynamicPersistentTileSchedulerXe4(Params const& params)
    : params_(params) {}

  CUTLASS_DEVICE
  DynamicPersistentTileSchedulerXe4(CLCResponse* clc_response_ptr, Params const& params)
    : clc_response_ptr_(clc_response_ptr), params_(params) {}

  CUTLASS_DEVICE
  DynamicPersistentTileSchedulerXe4(CLCResponse* clc_response_ptr, Params const& params, dim3 block_id_in_cluster)
    : clc_response_ptr_(clc_response_ptr), params_(params), block_id_in_cluster_(block_id_in_cluster) {}

  template <class ProblemShapeMNKL, class TileShape>
  CUTLASS_DEVICE
  DynamicPersistentTileSchedulerXe4(CLCResponse* clc_response_ptr, Params const& params, ProblemShapeMNKL, TileShape, dim3 block_id_in_cluster)
    : DynamicPersistentTileSchedulerXe4(clc_response_ptr, params, block_id_in_cluster) {}
