                     ...
                     DilationStride               const& stride_srt)        // dilation
{
  ...
  using Im2ColDesc = xe4::Im2ColDescriptor<T, num_bytes_per_tma>;
  ...
  Im2ColDesc desc = cute::xe4::make_async_row_copy_desc<num_bytes_per_tma>(gtensor);
                     ...
                     DilationStride           const& stride_srt)
{
  ...
  auto tma_atom = detail::make_tma_atom_im2col<CopyOp>(tensor_cwhdn, slayout, multicast_size, cta_v_tile,
