...
template <> struct fixed_s<384> { static constexpr fixstr::fixed_string value {"384"};};
...
template <> struct rd_type<unsigned char> {static constexpr fixstr::fixed_string value {".8b.uint"};};
