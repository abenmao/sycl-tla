...
CUTE_HOST_DEVICE
  ...
  // NOTE: to convert this to non-asymmetric register allocation replace
  // this if condition with if (my_sg_id < 4) (for wg_size 384) //
  if (syclex::is_control_sub_group()) {
    ...
    while (ktile_idx < ktile_count) {
      { // copy the tile(s) from gmem to slm using ADMAs // 
        ...
        ////////////////////////////////////////////////////////////////////////
        //XESIM or COMPILER issue:  ideally we could delete lines 234-248,
        //however XESIM with asymmetric register allocation returns wrong 
        //results, this could be a compiler or XESIM issue.
        ////////////////////////////////////////////////////////////////////////
#if 0
