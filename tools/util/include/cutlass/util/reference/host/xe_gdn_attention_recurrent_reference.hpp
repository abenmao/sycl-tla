...
/*!
  \file xe_gdn_attention_recurrent_reference.hpp
  \brief Single-shot per-token recurrent host reference -- the
         E2E oracle for the Xe GDN kernel.
  ...
  (xe_gdn_attention_stage_references.hpp) stay in place as the per-kernel
...
#include "gdn_attention/xe_chunk_gated_delta_rule.hpp"  // cutlass::gdn::kChunkSize
