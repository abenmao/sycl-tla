/*!
  \file xe_chunk_gated_delta_rule_kernels.hpp
  \brief Xe SYCL device kernels for the five-stage chunkwise Gated DeltaNet
  ...
  is exposed through xe_chunk_gated_delta_rule_launch.hpp.
*/
...
#include "xe_chunk_gated_delta_rule_gemm.hpp"
...
#include "gdn_attention/xe_chunk_gated_delta_rule.hpp"
 ...
 * cutlass::gdn::kChunkSize (defined in xe_chunk_gated_delta_rule.hpp, included
